...
; ------------------------------------------------------------------
; Au REPOS : uniquement le sondage clavier (firmware pur, AUCUN acces M4).
; La carte M4 n'est touchee que pour envoyer un caractere reellement tape.
; (La lecture repetee de sockstat en boucle destabilisait le firmware M4.)
mainloop:	call	KM_READ_CHAR
		jr	nc, mainloop		; pas de touche -> boucler, rien d'autre
		cp	#0xFC			; ESC ?
		jp	z, quit
		push	af
