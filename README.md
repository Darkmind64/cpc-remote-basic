...
![cpcview running on Amstrad CPC 128K](screenshots/cpcview-main.png)

*The graphical viewer showing an Amstrad CPC 128K with M4 Board, displaying BASIC ready prompt with terminal active*
